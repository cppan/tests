...
local_settings:
    build:
        c_compiler: /home/egor/dev/gcc-install/bin/gcc
        cxx_compiler: /home/egor/dev/gcc-install/bin/g++
        cxx_flags: -std=c++1z -fconcepts
dependencies:
    pvt.cppan.demo.concepts.text_view: master
*/
